...
class JFakeElementTagsTag extends JFakeElementBase
{
	var	$_name = 'TagsTag';
	...
	public function getInput() 
	{
		...
		$model = JModel::getInstance( 'ElementTag', 'TagsModel' );
...
if(version_compare(JVERSION,'1.6.0','ge')) {
	class JFormFieldTagsTag extends JFakeElementTagsTag {}
} else {
	class JElementTagsTag extends JFakeElementTagsTag {}
}
