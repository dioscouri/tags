...
JLoader::import( 'com_tags.library.plugins._base', JPATH_ADMINISTRATOR.DS.'components' );
JLoader::import( 'com_tags.models._base', JPATH_ADMINISTRATOR.DS.'components' );

class TagsReportPlugin extends TagsPluginBase
{
    /**
    ...
    function _getNamespace()
    {
        ...
        $ns = $app->getName().'::'.'com.tags.report.'.$this->get('_element');
        return $ns;
    }
     ...
     * @return array
     */
    function _getModel( $name = '', $prefix = 'TagsModel', $config = array() )
    {
    	if (empty( $name ))
    	{
