...
class TagsModelElementScope extends DSCModelElement
{
    var $title_key = 'scope_name';
    var $select_title_constant = 'Select a Scope';
    var $select_constant = 'Select';
    var $clear_constant = 'Clear';

    public function getTable($name='Scopes', $prefix='TagsTable', $options = array())
    {
    ...
    protected function _buildQueryWhere(&$query)
    {
        ...
        if ($filter)
        {
            ...
            $where[] = 'LOWER(tbl.scope_title) LIKE '.$key;
        ...
        if (strlen($filter_title))
        {
            ...
            $query->where('LOWER(tbl.scope_title) LIKE '.$key);
        }
