<?php defined('_JEXEC') or die('Restricted access'); ?>
	...
	<?php
		...
		$img_path = "../media/com_tags/images";

		$url = "http://www.dioscouri.com/";
		if ($amigosid = Tags::getInstance()->get( 'amigosid', '' ))
		{
	...
	<tr>
		...
		<td style="text-align: center; width: 33%;">
			<?php echo JText::_( "Tags" ); ?>: <?php echo JText::_( "TAGS_DESC" ); ?>
			<br/>
			<?php echo JText::_( "Copyright" ); ?>: <?php echo Tags::getInstance()->getCopyrightYear(); ?> &copy; <a href="<?php echo $url; ?>" target="_blank">Dioscouri Design</a>
			<br/>
			<?php echo JText::_( "Version" ); ?>: <?php echo Tags::getInstance()->getVersion(); ?>
		</td>
