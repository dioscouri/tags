     ...
     * This should be renamed to tagsResetFormFilters
     * 
     * @param form
     * @return
     */
    function tagsFormReset(form)
    {
	 ...
	 * @param {Object} task
	 */
	function tagsGridOrdering( order, dir ) 
	{
	 ...
	 * @return
	 */
	function tagsGridOrder(id, change) 
	{
		var form = document.adminForm;
     ...
     */
    function tagsFormValidation( url, container, task, form ) 
    {
	 ...
	 */
	function tagsDisplayDiv (divname, spanname, showtext, hidetext) { 
	 ...
	 */
	function tagsSwitchDisplayDiv( prefix, newSuffix )
	{
	...
	function tagsShowHideDiv(divname)
	{
	 ...
	 */
	function tagsDoTask( url, container, form, msg ) 
	{
		tagsNewModal(msg);
		...
		{	
            ...
            var a=new Ajax(url,{
                ...
                onComplete: function(response){
                    ...
                    (function() { document.body.removeChild($('tagsModal')); }).delay(500);
                    return true;
                }
            }).request();
		}
	...
	function tagsNewModal (msg)
	{
		...
		var src = 'media/com_tags/images/ajax-loader.gif';
	 ...
	 * @return string
	 */
	function tagsGetCheckedValue(radioObj) 
	{
	    if (!radioObj) { return ""; }
