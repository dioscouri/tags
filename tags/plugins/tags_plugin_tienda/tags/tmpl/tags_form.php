...
<?php JHTML::_('stylesheet', 'tags.css', 'plugins/tienda/tags/media/'); ?>
<?php
	$tags      = $vars->tags;
	$addUrl    = 'index.php?format=raw&option=com_tags&controller=tags&task=doTaskAjax&element=tags.tienda&elementTask=addTag';
	$removeUrl = 'index.php?format=raw&option=com_tags&controller=tags&task=doTaskAjax&element=tags.tienda&elementTask=removeTag&relationship_id=';	
?>
